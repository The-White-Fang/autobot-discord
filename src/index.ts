...
import { DiscordComnad, register_commands, register_intents } from '@bot/discord/functions';
...
async function post_start() {
	...
	try {
		await register_commands(discrod_rest_client, app_id, discord_commands as any as DiscordComnad[]);
